...
<head>
  ...
  <title>Novine | ENERGY CONTACT MONT DOO</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
          ...
          <div class="row">
            <div class="col-md-7 pull-right text-right">
              <p>
                ...
                <span><i class="far fa-clock fa-lg"></i> Pon - Pet 9:00 - 17:00</span>
              </p>
            </div>	
            <div class="col-md-5">
      ...
      <div class="container">
        ...
        <li><a href="/">Početna</a>
            ...
            <li class="drop"><a class="active" href="novine.php">Novine</a>
            </li>
          ...
          <div class="carousel-caption text-center animated bounceInDown" style="animation-duration: 1.7s;">
            <div class="background-center">
              ...
              <p class="caption-text">
                <a class="btn btn-theme btn-theme-md" href="/kontakt.php">Kontakt</a>
              </p>
            </div>
          </div>
        </div>
...
<section class="gradilista">
  <div class="container">
    <div class="row">
    <h1>Gradilišta</h1>
    <div class="col-lg-12 col-md-12 col-sm-12">
       <img src="/img/gradilisteNaslovna.jpg" alt="Slika gradilišta" class="img-responsive">
    </div>
    </div>

    <div class="row vertical">
<div class="col-md-7 text-left info-left">
          <p>Potpisan ugovor sa KC Kragujevac o rekonstrukciji elektroinstalacija na odeljenjima neurologije, dermatologije, EFS, farmakologije, apoteke i jednog dela uprave.</p>

          <h2>Maj 2020</h2>
</div>
<div class="col-md-5">
    <img src="/img/hospital.jpg" alt="Slika gradilišta" class="img-responsive slikaBolnice">
    </div>
    </div>
  </div>
</section>
...
<section class="akcije">
    <div class="container">
    <div class="row">
    <h1>Trenutne akcije</h1>
    <div class="col-md-4">

    <div class="post clearfix">

    <a href="#" title="Dekorativna rasveta">
          <div class="image-container">
            <img src="img/dekorativnaRasveta.jpg" alt="Dekorativna rasveta" class="img-responsive">
           <div class="after"></div>
          </div>
        </a>
            <h1>Dekorativna rasveta</h1>
          <div class="post-prev-text">
            <p>Trenutno je u ponudi dekorativna i ostala rasveta po veoma povoljnim cenama. Svi proizvodi su dostupni na 
              našoj adresi Perice Maksimovića 2. U prilogu se nalazi katalog gde možete pogledati celokupnu ponudu dekorativne rasvete.
            </p>
            
          </div>
          <div class="post-prev-button">
            <a href="#" title="Katalog dekorativne rasvete" class="btn btn-default">POGLEDAJ KATALOG</a>
          </div>
