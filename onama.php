...
<head>
  ...
  <title>O nama | ENERGY CONTACT MONT DOO</title>
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li><a href="/">Početna</a>
            ...
            <li class="drop"><a class="active" href="onama.php">O nama</a>
            </li>
  ...
  <!-- Carrousel END -->
   ...
   <!-- <section class="picture-onama">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <img src="img/onama-radnici.jpeg" alt="Radnici, električari" class="img-responsive">
            </div>
          </div>
        </div>
      </section> -->
  ...
  <!-- O nama text START -->
      <section class="text-onama">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-header">O NAMA</h2>
              <div class="line"></div>
              <p>Osnovna delatnost preduzeća je prodaja niskonaponske opreme, kablova, led rasvete, modularne galanterije i ostalog elektroinstalacionog materijala renomiranih
                Svetskih proizvodjača.
                Izvođenje i projektovanje elektroinstalacija i strukturnih kablovskih sistema,
                Izrada razvodnih i komadnih ormana.</p>
                <p> U proteklih nekoliko godina uz znanje koje
                  posedujemo i stalnom edukacijom, praćeno permanentnim radom na terenu na
                  objektima različite namene, stekli smo veliko iskustvo pa možemo reći da
                  smo kao firma sposobni da izvedemo sve radove iz domena
                  elektroenergetskih radova.</p>
            </div>
          </div>
        </div>
      </section>
