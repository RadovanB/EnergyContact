...
<head>
  ...
  <title>Dokumenti | ENERGY CONTACT MONT DOO</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li><a href="/">Početna</a>
            ...
            <li class="drop"><a class="active" href="dokumenti.php">Dokumenti</a>
            </li>
    ...
    <div id="carousel-example-2" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <!--Mask color-->
          <div class="view">
            <img class="img-responsive" src="img/slide2.jpg" alt="Second slide">
            <div class="mask rgba-black-strong"></div>
          </div>
          <div class="carousel-caption text-left animated bounceInRight" style="animation-duration: 1.7s;">
            <div class="background-left">
              <h2 class="h3-responsive">Uvek smo dostupni za naše klijente!</h2>
        ...
        <div class="item">
          <!--Mask color-->
          <div class="view">
            <img class="img-responsive" src="img/slide3.jpg" alt="Third slide">
            <div class="mask rgba-black-slight"></div>
          </div>
          <div class="carousel-caption text-right animated bounceInLeft" style="animation-duration: 1.7s;">
            <div class="background-right">
              <h2 class="h3-responsive">Iskustvo dugo nekoliko decenija.</h2>
        ...
        <div class="item">
          <!--Mask color-->
          <div class="view">
            <img class="img-responsive" src="img/slide4.jpg" alt="Third slide">
            <div class="mask rgba-black-slight"></div>
          </div>
      ...
      <a class="left carousel-control" href="#carousel-example-2" role="button" data-slide="prev">
        <div class="owl-prev" aria-hidden="true">
          <i class="fa fa-angle-left"></i>
        </div>
      </a>
      <a class="right carousel-control" href="#carousel-example-2" role="button" data-slide="next">
        <div class="owl-next" aria-hidden="true">
...
<!-- Our services START -->
<section class="sertifikati">
  <div class="container">
    
    <div class="row">
    <div class="col-md-12 mt25">
        <h2 class="text-header">Sertifikati</h2>
          <div class="line"></div>
    </div>

    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/19032.pdf" height="460" ></iframe>
            <a href="dokumentacija/19032.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
    ...
    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/19032e.pdf" height="460" ></iframe>
            <a href="dokumentacija/19032e.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
    ...
    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/OHSAS.pdf" height="460" ></iframe>
            <a href="dokumentacija/OHSAS.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/OHSASe.pdf" height="460" ></iframe>
            <a href="dokumentacija/OHSASe.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
    </div>

    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/QMS.pdf" height="460" ></iframe>
            <a href="dokumentacija/QMS.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
    </div>

    <div class="col-md-4">
        <div style="position: relative;">
            <iframe src="dokumentacija/QMSe.pdf" height="460" ></iframe>
            <a href="dokumentacija/QMSe.pdf" style="position:absolute; top:0; left:0; display:inline-block; width: 100%; height:500px; z-index:5;"></a>
        </div>
    </div>
</div>
  <!-- </div> -->
